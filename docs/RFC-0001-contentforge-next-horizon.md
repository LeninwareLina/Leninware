...
50: 1. **Hook & Agitation (0% - 15%):** Present a concrete, relatable local contradiction.
51: 2. **Structural Mapping (15% - 80%):** Detail the institutional, political, and financial networks (exposing switching points).
52: 3. **Solidarity/Action (80% - 100%):** Direct the viewer toward mutual aid or local organizing groups.
